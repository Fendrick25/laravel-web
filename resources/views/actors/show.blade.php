...
@section('content')
    <div class="px-5 d-flex gap-3 mt-5">
        <div>
            <img src="{{ url('storage/images/actors/' . $actor->imageUrl) }}" style="height: 30rem">
        ...
        <div class="mx-3">
            ...
            <div class="d-flex row justify-content-start gap-5 mt-4" style="margin-left: 2.25px">
                @foreach ($actor->characters as $character)
                    <div class="card col-4 p-0 bg-dark" style="width: 12rem; border-color: white;">
                        <img src="{{ url('storage/images/actors/' . $character->actor->imageUrl) }}" class="card-img-top">
                        <div class="card-body">
